...

{
  ...
  },
  {
    novelId: 'shen-mu',
    novelTitle: '神墓',
    overview: '辰东经典之作，少年辰南从神墓中苏醒，发现自己已万载之后。以无敌之姿横扫诸天，逆天伐道，追寻万古真相。独孤败天、魔主、人王等绝代强者轮番登场，万古棋局波澜壮阔。',
    feature: '辰南从神墓苏醒，逆天伐道',
    levels: [
    {
      order: 1,
      name: '炼精化气',
      description: '炼化精气，踏入修行之始',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '炼气化神',
      description: '灵力凝聚，神识初开',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '炼神还虚',
      description: '神识返虚，与天地沟通',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '炼虚合道',
      description: '虚空合道，初窥天道之妙',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '仙武之境',
      description: '仙武合一，超越凡俗极限',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '天阶',
      description: '天阶强者，操控天地之力',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '神王',
      description: '神王之威，一方霸主',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '神皇',
      description: '神皇之尊，统治一方',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '至尊',
      description: '至尊之力，天地巅峰',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '逆天级',
      description: '逆天而行，挑战天道法则',
      keyAbilities: [],
    },
    ],
  },
  ...
  // ===== 起点修仙推荐榜补充 =====
{
    novelId: 'bu-xiu-fan-ren',
    novelTitle: '不朽凡人',
    overview: '平凡少年莫无忌资质平庸，却意外获得神秘功法，从聚气开始逆天修行，一步步证道不朽。凡人流的经典代表。',
    feature: '资质平庸逆天修仙，证道不朽',
    levels: [
    {
      order: 1,
      name: '聚气境',
      description: '聚气境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '凝元境',
      description: '凝元境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '元丹境',
      description: '元丹境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '元神境',
      description: '元神境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '化神境',
      description: '化神境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '炼虚境',
      description: '炼虚境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '合体境',
      description: '合体境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '大乘境',
      description: '大乘境，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '渡劫境',
      description: '渡劫境，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '真仙境',
      description: '真仙境，修为精进',
      keyAbilities: [],
    },
    {
      order: 11,
      name: '金仙境',
      description: '金仙境，修为精进',
      keyAbilities: [],
    },
    {
      order: 12,
      name: '大罗境',
      description: '大罗境，修为精进',
      keyAbilities: [],
    },
    {
      order: 13,
      name: '不朽境',
      description: '不朽境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'chi-xin-xun-tian',
    novelTitle: '赤心巡天',
    overview: '姜望以赤子之心修行，在大争之世守护家国天下。修行体系严谨，家国情怀与修仙交织。',
    feature: '赤子之心行巡天之路，家国修仙',
    levels: [
    {
      order: 1,
      name: '开脉境',
      description: '开脉境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '凝气境',
      description: '凝气境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '筑基境',
      description: '筑基境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '金丹境',
      description: '金丹境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '元婴境',
      description: '元婴境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
  ...
  {
    novelId: 'guang-yin-zhi-wai',
    novelTitle: '光阴之外',
    overview: '耳根全新力作，在光阴长河之外寻找永恒。全新的修行体系与世界观。',
    feature: '超越光阴长河，寻找永恒',
    levels: [
    {
      order: 1,
      name: '觉明境',
      description: '觉明境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '洞虚境',
      description: '洞虚境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '窥天境',
      description: '窥天境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '命星境',
      description: '命星境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '神曜境',
      description: '神曜境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '超脱境',
      description: '超脱境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '光阴境',
      description: '光阴境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '永恒境',
      description: '永恒境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'da-fu-zhuan-shi',
    novelTitle: '大符篆师',
    overview: '少年以符篆入道，在符道一途独步天下。符篆修炼体系独特，将传统符箓之道发扬光大。',
    feature: '以符篆入道，独步天下',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 10,
      name: '大符篆师',
      description: '大符篆师，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'xian-gong-kai-wu',
    novelTitle: '仙工开物',
    overview: '以仙工之术为核心修炼体系，炼器、开物、造化三位一体。',
    feature: '仙工之术开物造化',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 3,
      name: '大匠师',
      description: '大匠师，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '仙工师',
      description: '仙工师，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '天工师',
      description: '天工师，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '造化师',
      description: '造化师，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '开物师',
      description: '开物师，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '仙工大师',
      description: '仙工大师，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'mei-qian-xiu-shen-me-xian',
    novelTitle: '没钱修什么仙？',
    overview: '当修仙也需要氪金，一个穷小子如何在修仙界靠穷修逆袭？以幽默诙谐的笔触描写修仙界的经济生态。',
    feature: '氪金修仙时代的穷修逆袭',
    levels: [
    {
      order: 1,
      name: '穷修一段',
      description: '穷修一段，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '穷修二段',
      description: '穷修二段，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '穷修三段',
      description: '穷修三段，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '穷修四段',
      description: '穷修四段，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '穷修五段',
      description: '穷修五段，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '小康修士',
      description: '小康修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '富裕修士',
      description: '富裕修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '土豪修士',
      description: '土豪修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
  ...
  },
  {
    novelId: 'xian-gong',
    novelTitle: '仙宫',
    overview: '少年偶得仙宫传承，从此踏上修仙之路。仙宫中藏有无数功法宝物，成为修行最大底牌。',
    feature: '仙宫传承，纵横天下',
    levels: [
    {
      order: 1,
      name: '炼气期',
      description: '炼气期，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '筑基期',
      description: '筑基期，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '结丹期',
      description: '结丹期，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '元婴期',
      description: '元婴期，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '化神期',
      description: '化神期，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '炼虚期',
      description: '炼虚期，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '合体期',
      description: '合体期，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '大乘期',
      description: '大乘期，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '渡劫期',
      description: '渡劫期，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '真仙期',
      description: '真仙期，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'wo-zhen-bu-shi-xian-er-dai',
    novelTitle: '我真不是仙二代',
    overview: '修仙界大佬转世重生到现代都市，本想低调修行却被误认为是仙二代。轻松搞笑的都市修仙日常。',
    feature: '大佬转世被误认仙二代',
    levels: [
    {
      order: 1,
      name: '一级修士',
      description: '一级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '二级修士',
      description: '二级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '三级修士',
      description: '三级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '四级修士',
      description: '四级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '五级修士',
      description: '五级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '六级修士',
      description: '六级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '七级修士',
      description: '七级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '八级修士',
      description: '八级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '九级修士',
      description: '九级修士，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
  ...
  {
    novelId: 'gan-chu-ge-wan-fa-dao-jun',
    novelTitle: '肝出个万法道君',
    overview: '资质平平的少年修士，凭借肝帝精神硬生生肝出万法归一，成就道君之位。',
    feature: '肝帝精神硬肝万法归一',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 10,
      name: '万法道君',
      description: '万法道君，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'wen-dao-hong-chen',
    novelTitle: '问道红尘',
    overview: '修士在红尘与仙途之间寻找平衡，情感与道心并行。以细腻笔触描绘修仙世界的人情冷暖。',
    feature: '红尘中问道，仙途上寻真',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 10,
      name: '金仙期',
      description: '金仙期，修为精进',
      keyAbilities: [],
    },
    {
      order: 11,
      name: '问道境',
      description: '问道境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'tian-ming-di-yi-xian',
    novelTitle: '天命第一仙',
    overview: '天命之子踏上修仙之路，以天命之力横推一切阻碍。天命修炼体系独特。',
    feature: '天命之力横推一切',
    levels: [
    {
      order: 1,
      name: '觉醒境',
      description: '觉醒境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '凝命境',
      description: '凝命境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '铸命境',
      description: '铸命境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
    ...
    },
    {
      order: 5,
      name: '天命境',
      description: '天命境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '超凡境',
      description: '超凡境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '入圣境',
      description: '入圣境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '仙人境',
      description: '仙人境，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '第一仙',
      description: '第一仙，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'dao-tian-xian-tu',
    novelTitle: '盗天仙途',
    overview: '以盗入道，窃取天地造化。主角以偷天换日之术修行，在正邪之间游走。',
    feature: '以盗入道，窃取天地造化',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 11,
      name: '盗天境',
      description: '盗天境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'xian-ling-yao-shen-ji',
    novelTitle: '仙灵妖神记',
    overview: '仙灵妖三族共存的世界中，少年踏上贯通三族的修行之路，成就妖神之名。',
    feature: '三族贯通修仙之路',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 8,
      name: '妖神境',
      description: '妖神境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'jian-tu-zhi-lu',
    novelTitle: '剑徒之路',
    overview: '以剑入道，少年修士在剑道一途独步天下。剑修体系严谨，战斗场面精彩。',
    feature: '以剑入道，剑徒独步',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'shan-hai-ti-deng',
    novelTitle: '山海提灯',
    overview: '少年提灯行走山海之间，在神话与修仙交织的世界中证道长生。山海经元素与修仙体系结合。',
    feature: '提灯行走山海之间',
    levels: [
    {
      order: 1,
      name: '点灯境',
      description: '点灯境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '照夜境',
      description: '照夜境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '引路境',
      description: '引路境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '渡岸境',
      description: '渡岸境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '观海境',
      description: '观海境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '望岳境',
      description: '望岳境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '巡天境',
      description: '巡天境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '山海境',
      description: '山海境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'cong-tian-ting-kai-shi',
    novelTitle: '从天庭开始打造神话',
    overview: '重生天庭，从零开始打造神话体系。主角以现代思维重建天庭秩序。',
    feature: '重生天庭打造神话体系',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 8,
      name: '造化天尊',
      description: '造化天尊，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'dao-yuan-ru-xian',
    novelTitle: '道缘儒仙',
    overview: '少年书生以儒学根基踏上修仙之路，将儒家思想与修仙结合，开创儒仙一脉。',
    feature: '以儒入道开创儒仙一脉',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'wo-shi-xian-fan',
    novelTitle: '我是仙凡',
    overview: '一个平凡少年，在仙与凡之间寻找自己的道路，以凡人之躯成就仙人之境。',
    feature: '仙与凡之间寻找道路',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'ze-tian-ji',
    novelTitle: '择天记',
    overview: '少年陈长生命格有缺，为改命而踏上修行之路。国教修行体系宏大，命理与修仙交织。',
    feature: '逆天改命，国教修行',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'jiang-ye',
    novelTitle: '将夜',
    overview: '少年宁缺从渭城小卒成长为书院弟子，在昊天道与魔宗之间寻找自己的道。',
    feature: '书院修行，昊天道',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'mu-shen-ji',
    novelTitle: '牧神记',
    overview: '少年秦牧在大墟中被残老村众人抚养长大，走出大墟后以牧道修仙。',
    feature: '牧道修仙，大墟少年',
    levels: [
    {
      order: 1,
      name: '搬血境',
      description: '搬血境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '列阵境',
      description: '列阵境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '通神境',
      description: '通神境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '灵胎境',
      description: '灵胎境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
    ...
    },
    {
      order: 6,
      name: '天象境',
      description: '天象境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '化龙境',
      description: '化龙境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '帝尊境',
      description: '帝尊境，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '仙台境',
      description: '仙台境，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '天尊境',
      description: '天尊境，修为精进',
      keyAbilities: [],
    },
    {
      order: 11,
      name: '道尊境',
      description: '道尊境，修为精进',
      keyAbilities: [],
    },
    {
      order: 12,
      name: '混沌境',
      description: '混沌境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'sheng-xu',
    novelTitle: '圣墟',
    overview: '灵气复苏时代楚风崛起，在进化路上走向巅峰。与遮天、完美世界共享同一宇宙观。',
    feature: '灵气复苏，进化之路',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 2,
      name: '枷锁境',
      description: '枷锁境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '逍遥境',
      description: '逍遥境，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '观想境',
      description: '观想境，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '餐霞境',
      description: '餐霞境，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '塑体境',
      description: '塑体境，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '化形境',
      description: '化形境，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
    ...
    },
    {
      order: 12,
      name: '进化路尽头',
      description: '进化路尽头，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'xiu-zhen-shi-jie',
    novelTitle: '修真世界',
    overview: '散修左莫在修真世界中摸爬滚打，凭借独特悟性和坚韧意志走出自己的修真之路。',
    feature: '散修摸爬滚打的修真之路',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'jiu-ding-ji',
    novelTitle: '九鼎记',
    overview: '一个来自地球的武者在九州大陆重新修炼，以形意拳之根基踏上巅峰之路。',
    feature: '形意拳武道修真',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'mang-huang-ji',
    novelTitle: '莽荒纪',
    overview: '少年纪宁在莽荒世界中修炼，从凡人到宇宙掌控者。心力与神力双修体系独特。',
    feature: '心力与神力双修',
    levels: [
    {
      order: 1,
      name: '先天境界',
      description: '先天境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '紫府境界',
      description: '紫府境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '万象境界',
      description: '万象境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '元神境界',
      description: '元神境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '返虚境界',
      description: '返虚境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '天仙境界',
      description: '天仙境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '真仙境界',
      description: '真仙境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '祖仙境界',
      description: '祖仙境界，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '世界境',
      description: '世界境，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '混沌仙人',
      description: '混沌仙人，修为精进',
      keyAbilities: [],
    },
    {
      order: 11,
      name: '大道仙人',
      description: '大道仙人，修为精进',
      keyAbilities: [],
    },
    {
      order: 12,
    ...
    },
    {
      order: 13,
      name: '宇宙掌控者',
      description: '宇宙掌控者，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'xue-ying-ling-zhu',
    novelTitle: '雪鹰领主',
    overview: '少年东伯雪鹰以枪法入道，在虚空之中开辟修行之路，成就领主之名。',
    feature: '枪法与虚空道双修',
    levels: [
    {
      order: 1,
      name: '普通骑士',
      description: '普通骑士，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '银月骑士',
      description: '银月骑士，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '流星骑士',
      description: '流星骑士，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
  ...
  },
  {
    novelId: 'cun-mang',
    novelTitle: '寸芒',
    overview: '小李飞刀传人在修真世界以飞刀之术证道，寸芒之间取人首级。',
    feature: '飞刀修仙，寸芒取人',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'xing-feng-chuan-shuo',
    novelTitle: '星峰传说',
    overview: '一个修真者在星峰之上悟道修行，从凡人到仙人的传奇之路。',
    feature: '星峰悟道修行',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'fei-sheng-zhi-hou',
    novelTitle: '飞升之后',
    overview: '修真者飞升之后的世界远比想象中残酷，仙界不过是新的战场。',
    feature: '飞升之后的残酷仙界',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'xian-lu-zhi-zun2',
    novelTitle: '仙路至尊',
    overview: '少年在仙路上争锋，以独特天赋与坚韧意志走上至尊之路。',
    feature: '仙路争锋至尊之路',
    levels: [
    {
      order: 1,
  ...
  {
    novelId: 'wan-jie-tian-zun',
    novelTitle: '万界天尊',
    overview: '少年在万界之中修行，以天尊之姿横压诸天万界。',
    feature: '万界修行天尊之姿',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'tian-shu',
    novelTitle: '天枢',
    overview: '以天枢为核心讲述修士证道之路，将传统道法与哲学思辨结合。',
    feature: '天枢证道修行',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'shen-you',
    novelTitle: '神游',
    overview: '少年修士神游太虚，在梦境与现实中修行悟道。将传统道法与现代生活结合。',
    feature: '神游太虚梦境修行',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'ren-yu',
    novelTitle: '人欲',
    overview: '探讨人欲与天道之间的关系，在欲与道之间修行。',
    feature: '人欲与天道之间的修行',
    levels: [
    {
      order: 1,
  ...
  },
  {
    novelId: 'ling-shan',
    novelTitle: '灵山',
    overview: '以灵山为道场，讲述修士证道成仙之路。将佛道儒三教思想融为一炉。',
    feature: '佛道儒三教融合证道',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 10,
      name: '灵山境',
      description: '灵山境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'xiu-zhen-si-wan-nian',
    novelTitle: '修真四万年',
    overview: '修真文明发展四万年后的世界，少年修士在高度发达的修真文明中追寻大道。',
    feature: '科幻修真文明四万年',
    levels: [
    {
      order: 1,
      name: '锻体境',
      description: '锻体境，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '炼气境',
      description: '炼气境，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
  ...
  {
    novelId: 'wan-gu-zhi-zun2',
    novelTitle: '万古至尊',
    overview: '少年在万古传承中觉醒，以绝世天赋踏上至尊之路。',
    feature: '万古传承觉醒至尊',
    levels: [
    {
      order: 1,
    ...
    },
    {
      order: 8,
      name: '万古境',
      description: '万古境，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'tai-gu-long-xiang-jue',
    novelTitle: '太古龙象诀',
    overview: '少年获得太古龙象传承，以龙象之力横扫天下。',
    feature: '龙象传承力量修行',
    levels: [
    {
      order: 1,
      name: '龙象一重',
      description: '龙象一重，修为精进',
      keyAbilities: [],
    },
    {
      order: 2,
      name: '龙象二重',
      description: '龙象二重，修为精进',
      keyAbilities: [],
    },
    {
      order: 3,
      name: '龙象三重',
      description: '龙象三重，修为精进',
      keyAbilities: [],
    },
    {
      order: 4,
      name: '龙象四重',
      description: '龙象四重，修为精进',
      keyAbilities: [],
    },
    {
      order: 5,
      name: '龙象五重',
      description: '龙象五重，修为精进',
      keyAbilities: [],
    },
    {
      order: 6,
      name: '龙象六重',
      description: '龙象六重，修为精进',
      keyAbilities: [],
    },
    {
      order: 7,
      name: '龙象七重',
      description: '龙象七重，修为精进',
      keyAbilities: [],
    },
    {
      order: 8,
      name: '龙象八重',
      description: '龙象八重，修为精进',
      keyAbilities: [],
    },
    {
      order: 9,
      name: '龙象九重',
      description: '龙象九重，修为精进',
      keyAbilities: [],
    },
    {
      order: 10,
      name: '太古龙象',
      description: '太古龙象，修为精进',
      keyAbilities: [],
    },
    ],
  },
  {
    novelId: 'dao-jun2',
    novelTitle: '道君',
    overview: '少年以道门秘术行走天下，在权谋与修行之间寻找自己的道君之路。',
    feature: '道门秘术权谋修行',
    levels: [
    {
      order: 1,
